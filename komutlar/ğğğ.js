...
if(message.author.id !== "509417115439071233") if(message.author.id !== "509417115439071233") return message.channel.send("<:carpi:855750448711467058> Bu komut <@753842258457002036>' a özeldir!!")
